  ...
  render() {
    return (
      <div className="container my-3">
        <input value = {this.state.item} onChange={(e)=>{
          this.setState({item : e.target.valye})
        }} />
...
<InfiniteScroll
          ...
          <div className="row">
          {this.state.articles.filter((val)=>{
            if(this.state.item.toLowerCase().includes(val.title.toLowerCase)){
              return val
            }
          }).map((element) => {
            return (
